...
const finalColor = computed(
    () => props.color || props.item?.color || 'neutral',
);
const finalTo = computed(() => props.item?.to);

const isActive = computed(() =>
    finalTo.value ? route.path === finalTo.value : false,
);
...
<template>
    ...
    >
        ...
        >
            ...
            <div
                v-if="finalTo"
                class="absolute left-0 w-1 rounded-r-md transition-all duration-300 ease-out z-20"
                :class="[
                    themeStyles.bar,
            ...
            <div
                class="relative flex items-center justify-center h-10 shrink-0 z-10 transition-[width] duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1.0)]"
            ...
            <div
                class="flex items-center whitespace-nowrap overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.25,0.1,0.25,1.0)]"
                :class="[
                    !collapsed
            ...
            >
                <span
                    class="text-[0.925rem] transition-colors duration-200"
                    :class="[
                        isActive
