...
const links = computed(() => {
    ...
    if (
        ...
        user.value.permission >= AccountPermission.ADMIN
    ) {
        baseLinks.push('sep', {
            label: '玩家数据',
...
<template>
    ...
    >
        <aside
            ...
            :class="uiStore.isSidebarCollapsed ? 'w-18' : 'w-48'"
        >
            <!-- Logo -->
            <div
                class="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-800 shrink-0"
            >
                <span
            ...
            <!-- 底部工具 -->
            <div
                class="p-2 border-t border-gray-200 dark:border-gray-800 flex flex-col gap-2 shrink-0"
            >
                <!-- 1. 深色模式切换按钮：复用组件样式 -->
                <ClientOnly>
                    <SideMenuButton
                ...
                <SideMenuButton
                    ...
                    "
                    :label="uiStore.isSidebarCollapsed ? '展开' : '收起菜单'"
                    color="neutral"
        ...
        <div class="flex-1">
            <UMain
                class="flex-1 flex flex-col h-full relative z-10 transition-colors duration-300"
            >
                <header
            ...
            <UFooter>
                ...
                <template #right>
                    ...
                    <UButton
                        ...
                        color="neutral"
                        variant="ghost"
                        to="https://t.me/+DWY82Dp-zAw4NDRl"
                        target="_blank"
                        aria-label="Telegram"
                    />
                    <UButton
