    ...
    <div class="flex flex-col h-[calc(100vh-8rem)]">
        ...
        >
            ...
            >
                ...
                <div
                    class="px-4 py-2 rounded-2xl max-w-[80%]"
                    :class="[
                        msg.type === 'self'
                            ? 'bg-primary-500 text-white rounded-tr-sm'
                            : 'bg-white dark:bg-gray-700 rounded-tl-sm shadow-sm',
                        msg.type === 'system'
                            ? 'bg-gray-200 dark:bg-gray-600 text-xs italic w-full text-center rounded-lg'
                            : '',
                    ]"
                >
                    {{ msg.text }}
